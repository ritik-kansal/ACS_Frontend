                ...
                <div className="container">
                    <div className="flexBox">
                        ...
                        <div className="aboutRight">
                            ...
                            <Link to='/contact'><Button className={'HeroButton mt-40 mob-visible'} name={'Get in Touch'} /></Link>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="aboutMid gradientBG">
                <div className="container">
                    ...
                    <div className="x3BoxWrap mt-60">
                        <ServiceBox className={'solidCard'} src={'./assets/img/starpeople.png'} text={'Customer Experience'} detail={'At ACS we are committed to providing a world-class customer experience. Our team is made up of highly professional people who approach work with integrity & always seek to add value to the clients. We seek to build strong, long-term relationships with our clients by understanding their needs.'} />
                        <ServiceBox className={'solidCard'} src={'./assets/img/star.png'} text={'Excellence'} detail={'It is our policy at ACS to maintain the high standards that we started with. We do not compromise on quality in any area of our business. Whether it is hiring new people or working on a client’s project, we thrive on excellence. With our well structured internal quality controlprocedures.'} />
                        <ServiceBox className={'solidCard'} src={'./assets/img/helphand.png'} text={'Diversity'} detail={'ACS Consultancy Services Inc is a Small Business that is New York State and New York City Certified Minority and Women-Owned Business Enterprise. We provide Information Technology solutions and services, and IT consulting services to public sector entities.'} />
                    </div>
