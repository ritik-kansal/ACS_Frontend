                ...
                <div className="container">
                    ...
                    <div className="flexBox formDetailWrap">
                        <div className="formLeft">
                            ...
                            <p className="text-3 mt-20">Qualification Required: {job.qualification}</p>
                            <p className="text-3 mt-20">Job Location: {job.location}</p>
                            <p className="text-3 mt-20">Job Category: {job.job_category}</p>
                            <p className="text-3 mt-20">Job Type: {job.job_type}</p>
                        ...
                        <div className="formRight">
                            <form onSubmit={onSave} className='whiteForm contactForm'>
                                ...
                                <Input required={true} className={'mt-20'} type={'text'} placeholder={'Phone Number'} value={applicant.phone_number} onChange={(e) => setApplicant({ ...applicant, phone_number: e.target.value })} />
                                ...
                                <Input required={true} className={'mt-20'} type={'file'} placeholder={'Upload CV'} value={fileValue} onChange={(e) => handleFileChange(e)} />
